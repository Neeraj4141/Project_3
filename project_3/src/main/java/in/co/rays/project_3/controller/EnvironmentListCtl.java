 ...
 *
 */
@WebServlet(name = "EnvironmentListCtl", urlPatterns = { "/ctl/EnvironmentListCtl" })
public class EnvironmentListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(EnvironmentListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("EnvironmentListCtl doGet Method Start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("EnvironmentListCtl doPost method Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
				...
				if (ids != null && ids.length > 0) {
					...
					EnvironmentDTO deleteDto = new EnvironmentDTO();
	...
	protected String getView() {
		return ORSView.ENVIRONMENT_LIST_VIEW;
	}
}