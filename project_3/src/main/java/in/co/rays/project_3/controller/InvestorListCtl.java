...
public class InvestorListCtl extends BaseCtl {
    ...
    private static Logger log = Logger.getLogger(InvestorListCtl.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("InvestorListCtl doGet Start");
        ...
        log.debug("InvestorListCtl doGet End");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("InvestorListCtl doPost Start");
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) ||
                ...
                if (ids != null && ids.length > 0) {
                    InvestorDTO deleteBean = new InvestorDTO();
                    for (String id : ids) {
        ...
        log.debug("InvestorListCtl doPost End");
    }
