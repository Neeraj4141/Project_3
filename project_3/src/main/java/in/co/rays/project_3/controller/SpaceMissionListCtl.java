...
@WebServlet(name = "SpaceMissionListCtl", urlPatterns = { "/ctl/SpaceMissionListCtl" })
public class SpaceMissionListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(SpaceMissionListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("SpaceMissionListCtl doGet Start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("SpaceMissionListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					...
					SpaceMissionDTO deleteDto = new SpaceMissionDTO();
	...
	protected String getView() {
		return ORSView.SPACEMISSION_LIST_VIEW;
	}
}