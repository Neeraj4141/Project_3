...
@WebServlet(name = "DataRetentionListCtl", urlPatterns = { "/ctl/DataRetentionListCtl" })
public class DataRetentionListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(DataRetentionListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("DataRetentionListCtl doGet Method Start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("DataRetentionListCtl doPost method Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					...
					DataRetentionDTO deleteDto = new DataRetentionDTO();
	...
	protected String getView() {
		return ORSView.DATARETENTION_LIST_VIEW;
	}
}