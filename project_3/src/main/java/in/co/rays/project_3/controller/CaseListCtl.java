...
@WebServlet(name = "CaseListCtl", urlPatterns = { "/ctl/CaseListCtl" })
public class CaseListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(CaseListCtl.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CaseListCtl doGet Method Start");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("CaseListCtl doPost method Start ");
