...
@WebServlet(name = "OTPVerificationListCtl", urlPatterns = { "/ctl/OTPVerificationListCtl" })
public class OTPVerificationListCtl extends BaseCtl {

    private static Logger log = Logger.getLogger(OTPVerificationListCtl.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("OTPVerificationListCtl doGet Start");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("OTPVerificationListCtl doPost Start");
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    OTPVerificationDTO deleteDto = new OTPVerificationDTO();
    ...
    protected String getView() {
        return ORSView.OTPVERIFICATION_LIST_VIEW;
    }
}