				...
				<div class="card input-group-addon grad">
					<div class="card-body">
						...
						<%
							...
							if (dto.getPolicyName() != null && dto.getId() != null && dto.getId() > 0) {
						%>
						...
						<!-- POLICY NO -->
						<span class="pl-sm-5"><b>Policy No</b></span>
						<div class="col-sm-12">
							<div class="input-group">
								<input type="text" class="form-control" name="policyNo"
									value="<%=DataUtility.getStringData(dto.getPolicyNo())%>">
							</div>
						</div>
						...
						<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("policyName", request)%>
						</font></br>
						...
						<div class="text-center">
							...
							<input type="submit" name="operation"
								class="btn btn-success btn-md" value="<%=PolicyCtl.OP_UPDATE%>">

							<input type="submit" name="operation"
								class="btn btn-warning btn-md" value="<%=PolicyCtl.OP_CANCEL%>">
							<%
								} else {
							%>
							<input type="submit" name="operation"
								class="btn btn-success btn-md" value="<%=PolicyCtl.OP_SAVE%>">

							<input type="submit" name="operation"
								class="btn btn-warning btn-md" value="<%=PolicyCtl.OP_RESET%>">
							<%
								}
							%>
