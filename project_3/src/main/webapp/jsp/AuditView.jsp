				...
				<div class="card input-group-addon grad">
					<div class="card-body">
						...
						<%
							...
							if (dto.getAuditCode() != null && dto.getId() != null && dto.getId() > 0) {
						%>
						...
						<!-- AUDIT CODE -->
						<span class="pl-sm-5"><b>Audit Code</b> <span
						...
						<div class="col-sm-12">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="auditCode"
									placeholder="Audit Code"
									value="<%=DataUtility.getStringData(dto.getAuditCode())%>">
							</div>
						</div>
						<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("auditCode", request)%>
						</font></br>

						<!-- PERFORMED BY -->
						<span class="pl-sm-5"><b>Performed By</b> <span
							style="color: red;">*</span></span></br>
						<div class="col-sm-12">
							<div class="input-group">
								<div class="input-group-prepend">
						...
						<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("performedBy", request)%>
						</font></br>

						<!-- ACTION -->
						<span class="pl-sm-5"><b>Action</b> <span
							style="color: red;">*</span></span></br>
						<div class="col-sm-12">
							<div class="input-group">
								<div class="input-group-prepend">
								...
								<input type="text" class="form-control" name="action"
									placeholder="Action"
									value="<%=DataUtility.getStringData(dto.getAction())%>">
							</div>
						</div>
						<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("action", request)%>
						</font></br>
